...
interface BinaryRepositoryStorageAdapter {
     ...
     * @param streamWithLength an input stream with length information
    ...
    /**
     * Returns true if a temporary file exists at the specified location, false otherwise
     */
    fun temporaryFileExists(location: String): Boolean
