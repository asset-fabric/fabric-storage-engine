...
class LongListProperty(): AbstractSimpleListNodeProperty<String>() {

    constructor(vararg vals: Long): this() {
        this.setValues(vals.map { it.toString() })
    }

    override fun getType(): NodePropertyType = NodePropertyType.LONG
}