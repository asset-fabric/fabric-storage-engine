...
class ParameterizedNodeReferenceProperty(): AbstractComplexScalarNodeProperty() {

    private lateinit var properties: Map<String, SimpleNodeProperty>

    constructor(path: String, properties: Map<String, SimpleNodeProperty>): this() {
        this.setValue(path)
    ...
    fun getProperties(): Map<String, SimpleNodeProperty> = properties

    fun setProperties(props: Map<String, SimpleNodeProperty>) {
        properties = props
    }
