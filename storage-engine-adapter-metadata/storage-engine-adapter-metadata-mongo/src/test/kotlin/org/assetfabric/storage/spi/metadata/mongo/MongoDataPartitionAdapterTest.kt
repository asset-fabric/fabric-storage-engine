...
@DisplayName("A Mongo data partition adapter")
class MongoDataPartitionAdapterTest: DataPartitionAdapterTest() {

    @Configuration
    @Import(MongoTemplateConfiguration::class, MongoDataPartitionAdapter::class, EmbeddedMongoAutoConfiguration::class, MongoClientFactory::class)
